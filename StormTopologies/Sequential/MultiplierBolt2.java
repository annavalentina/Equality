...
public class MultiplierBolt2 extends BaseRichBolt {
    ...
    public MultiplierBolt2(TreeMap<Double, Integer> fractions, double selectivity, String mode) {
        this.fractions = fractions;
        this.selectivity = selectivity;
        this.mode = mode;
    }

    public MultiplierBolt2(double selectivity, String mode) {//For default storm
        this.selectivity = selectivity;
        this.mode = mode;
    }
    ...
    public void prepare(Map stormConf, TopologyContext topologyContext, OutputCollector collector) {
        ...
        this.tasksIds = topologyContext.getComponentTasks("AddingBolt1");//Get the tasks of the next node
