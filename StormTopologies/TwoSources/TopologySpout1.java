...
public class TopologySpout1 extends BaseRichSpout {

    TreeMap<Double, Integer> fractions;
    String mode;
    Integer numberOfTuples;

    public TopologySpout1(TreeMap<Double, Integer> fractions, String mode, Integer numberOfTuples) {
        this.fractions = fractions;
        this.mode = mode;
        this.numberOfTuples = numberOfTuples;
    }

    public TopologySpout1(String mode, Integer numberOfTuples) {//For default storm
        this.mode = mode;
        this.numberOfTuples = numberOfTuples;
    }
