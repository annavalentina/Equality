...
public class MultiplierBolt extends BaseRichBolt {
    ...
    public MultiplierBolt(TreeMap<Double, Integer> fractions, double selectivity, String mode) {
        this.fractions = fractions;
        this.selectivity = selectivity;
        this.mode = mode;
    }

    public MultiplierBolt(double selectivity, String mode) {//For default storm
        this.selectivity = selectivity;
        this.mode = mode;
    }
