...
public class TopologySpout2 extends BaseRichSpout {

    TreeMap<Double, Integer> fractions;
    String mode;
    Integer numberOfTuples;

    public TopologySpout2(TreeMap<Double, Integer> fractions, String mode, Integer numberOfTuples) {
        this.fractions = fractions;
        this.mode = mode;
        this.numberOfTuples = numberOfTuples;
    }

    public TopologySpout2(String mode, Integer numberOfTuples) {//For default storm
        this.mode = mode;
        this.numberOfTuples = numberOfTuples;
    }
    ...
    public void open(Map map, TopologyContext topologyContext, SpoutOutputCollector spoutOutputCollector) {
        ...
        this.tasksIds = topologyContext.getComponentTasks("MultiplierBolt2");//Get the tasks of the next node
